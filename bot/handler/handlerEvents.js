...
async function trackCommandSpam(threadID, threadName, globalData, message) {
        ...
        if (global.temp.commandSpamTracker[threadID].length >= spamConfig.commandThreshold) {
                ...
                message.reply(`⛔ | 𝚃𝚑𝚒𝚜 𝚐𝚛𝚘𝚞𝚙 𝚑𝚊𝚜 𝚋𝚎𝚎𝚗 𝚝𝚎𝚖𝚙𝚘𝚛𝚊𝚛𝚒𝚕𝚢 𝚋𝚊𝚗𝚗𝚎𝚍 𝚏𝚘𝚛 ${hours} 𝚑𝚘𝚞𝚛𝚜 𝚍𝚞𝚎 𝚝𝚘 𝚌𝚘𝚖𝚖𝚊𝚗𝚍 𝚜𝚙𝚊𝚖.\n\n𝙿𝚕𝚎𝚊𝚜𝚎 𝚠𝚊𝚒𝚝 𝚘𝚛 𝚌𝚘𝚗𝚝𝚊𝚌𝚝 𝚊𝚗 𝚊𝚍𝚖𝚒𝚗 𝚝𝚘 𝚞𝚗𝚋𝚊𝚗.`);
                
                global.utils.log.warn("SPAM_BAN", `𝚃𝚑𝚛𝚎𝚊𝚍 ${threadID} (${threadName}) 𝚋𝚊𝚗𝚗𝚎𝚍 𝚏𝚘𝚛 𝚌𝚘𝚖𝚖𝚊𝚗𝚍 𝚜𝚙𝚊𝚖`);
...
module.exports = function (api, threadModel, userModel, dashBoardModel, globalModel, usersData, threadsData, dashBoardData, globalData) {
                        ...
                        if (isGroup) {
                                ...
                                if (isSpamBanned) {
                                        if (!hideNotiMessage.threadBanned)
                                                message.reply("⛔ | 𝚃𝚑𝚒𝚜 𝚐𝚛𝚘𝚞𝚙 𝚒𝚜 𝚝𝚎𝚖𝚙𝚘𝚛𝚊𝚛𝚒𝚕𝚢 𝚋𝚊𝚗𝚗𝚎𝚍 𝚍𝚞𝚎 𝚝𝚘 𝚌𝚘𝚖𝚖𝚊𝚗𝚍 𝚜𝚙𝚊𝚖.");
                                        return;
                                }
						}
			...
			// ————————— CHECK MONEY REQUIREMENT (FIRST) ————————— //
                        ...
                        if (requiredMoney && requiredMoney > 0) {
                                ...
                                if (!hasEnoughMoney) {
                                        const userMoney = userData.money || 0;
                                        return await message.reply(
                                                `⚠ | 𝚈𝚘𝚞 𝚗𝚎𝚎𝚍 𝚊𝚝 𝚕𝚎𝚊𝚜𝚝 $${requiredMoney} 𝚝𝚘 𝚞𝚜𝚎 𝚝𝚑𝚒𝚜 𝚌𝚘𝚖𝚖𝚊𝚗𝚍.\n` +
                                                `𝚈𝚘𝚞𝚛 balance: $${userMoney}\n` +
                                                `𝚈𝚘𝚞 𝚗𝚎𝚎𝚍 $${requiredMoney - userMoney} 𝚖𝚘𝚛𝚎.`
                                        );
                                }
						}
	...
	if (!hideNotiMessage.needRoleToUseCmd) {
		if (needRole == 1)
			...
			return await message.reply(`⚠ | 𝚃𝚑𝚒𝚜 𝚌𝚘𝚖𝚖𝚊𝚗𝚍 𝚛𝚎𝚚𝚞𝚒𝚛𝚎𝚜 𝚙𝚛𝚎𝚖𝚒𝚞𝚖 𝚊𝚌𝚌𝚎𝚜𝚜 (𝚁𝚘𝚕𝚎 𝟹). 𝙲𝚘𝚗𝚝𝚊𝚌𝚝 𝚊𝚗 𝚊𝚍𝚖𝚒𝚗 𝚝𝚘 𝚐𝚎𝚝 𝚙𝚛𝚎𝚖𝚒𝚞𝚖 𝚜𝚝𝚊𝚝𝚞𝚜.`);
		else if (needRole == 4)
			return await message.reply(`⚠ | 𝚃𝚑𝚒𝚜 𝚌𝚘𝚖𝚖𝚊𝚗𝚍 𝚒𝚜 𝚏𝚘𝚛 𝚍𝚎𝚟𝚎𝚕𝚘𝚙𝚎𝚛𝚜 𝚘𝚗𝚕𝚢 (𝚁𝚘𝚕𝚎 𝟺). 𝙷𝚒𝚐𝚑𝚎𝚜𝚝 𝚙𝚎𝚛𝚖𝚒𝚜𝚜𝚒𝚘𝚗 𝚕𝚎𝚟𝚎𝚕 𝚛𝚎𝚚𝚞𝚒𝚛𝚎𝚍.`);
	}
	return true;
}
			// ———————————————— countDown ———————————————— //
